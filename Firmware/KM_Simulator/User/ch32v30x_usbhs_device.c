...
{
    USBHSD->ENDP_CONFIG = USBHS_UEP0_T_EN | USBHS_UEP0_R_EN | USBHS_UEP1_T_EN | USBHS_UEP2_T_EN | USBHS_UEP2_R_EN;
    ...
    USBHSD->UEP2_TX_DMA = (uint32_t)(uint8_t *)USBHS_EP2_Buf;
    USBHSD->UEP2_RX_DMA = (uint32_t)(uint8_t *)USBHS_EP2_Buf;
                ...
                switch (intst & (USBHS_UIS_TOKEN_MASK | USBHS_UIS_ENDP_MASK)) {
                    ...
                    case USBHS_UIS_TOKEN_OUT | DEF_UEP2:
                        ...
                        if (HID_Set_Report_Flag == SET_REPORT_DEAL_OVER) {
                            ...
                            USBHSD->UEP2_RX_CTRL = USBHS_UEP_R_RES_ACK | USBHS_UEP_R_TOG_DATA1;
                        }
                        //                     }
                        //                     printf("Set %d:\n", HID_Set_Report_Flag);
                        break;
                    ...
                    switch ((uint8_t)(USBHS_SetupReqValue >> 8)) {
                        ...
                        case USB_DESCR_TYP_REPORT:
                            if (USBHS_SetupReqIndex == 0x00) {
                                ...
                                pUSBHS_Descr = HIDReportDesc;
                                len          = DEF_USBD_REPORT_DESC_LEN_HID;
                            } else {
                                errflag = 0xFF;
                            }
                            break;
